...
public class Aggressor_stance_change_eff extends AbstractGameEffect {
    private TextureAtlas.AtlasRegion img;
    private float x;
    private float y;
    private float delayTimer;

    public Aggressor_stance_change_eff(float playerX) {
        this.img = ImageMaster.STRIKE_LINE;
        this.startingDuration = 1.0F;
        this.duration = this.startingDuration;
        this.color = new Color(MathUtils.random(0.0F, 0.3F), 1.0F, 1.0F, 0.0F);

...
public class Rock_Cannon_Mk2 extends AbstractDynamicCard {
    ...
    public static final String ID = BlackRockShooterMod.makeID(Rock_Cannon_Mk2.class.getSimpleName());
    public static final String IMG = makeCardPath("Rock_Cannon_Mk2.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p,
                new Rock_Cannon_Mk2_pw(p, p, magicNumber), magicNumber));
        /*

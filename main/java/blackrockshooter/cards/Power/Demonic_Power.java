...
import blackrockshooter.powers.Demonic_Power_pw;
...
public class Demonic_Power extends AbstractDynamicCard {
    ...
    public static final String ID = BlackRockShooterMod.makeID(Demonic_Power.class.getSimpleName());
    public static final String IMG = makeCardPath("Demonic_Power.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p,
                new Demonic_Power_pw(p, p, magicNumber), magicNumber));
        /*

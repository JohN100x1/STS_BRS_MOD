...
public class Charge_Shot extends AbstractDynamicCard {

    // Deal 4(7) Damage. Deal an additional 3 damage for each attack played this turn.

    public static final String ID = BlackRockShooterMod.makeID(Charge_Shot.class.getSimpleName());
    public static final String IMG = makeCardPath("Charge_Shot.png");

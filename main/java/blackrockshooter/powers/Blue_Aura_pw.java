...
public class Blue_Aura_pw extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = BlackRockShooterMod.makeID("Blue_Aura_pw");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("Blue_Aura84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("Blue_Aura32.png"));

    public Blue_Aura_pw(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
